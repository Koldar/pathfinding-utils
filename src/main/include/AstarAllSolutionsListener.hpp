#ifndef _PATHFINDINGUTILS_ASTARALLSOLUTIONSLISTENER_HEADER__
#define _PATHFINDINGUTILS_ASTARALLSOLUTIONSLISTENER_HEADER__
...
namespace pathfinding::search {
    ...
    class AstarAllSolutionsListener: public ICleanable {
    public:
        /**
